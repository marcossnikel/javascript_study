...
// PRIMEIRA FORMA >> DECLARAÇÃO DE FUNÇÃO !
...
text("Hello my frendo");
text("How are you my broda");
text(soma());


// Existem 3 formas de escrever as funções

//Primeira : logo acima , declarando a função.

function soma(){
    //outro códigos
    //diversos console.log
    //a linha do return tem que ser a ultima linha da função pois o return é a ultima linha executada pelo JS
    return 2 + 2; 
}
